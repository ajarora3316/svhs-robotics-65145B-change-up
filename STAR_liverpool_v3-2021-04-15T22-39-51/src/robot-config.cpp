...
drivetrain Drivetrain = drivetrain(LeftDriveSmart, RightDriveSmart, 299.24, 381, 114.3, mm, 1);
motor chuteMotor = motor(PORT5, ratio18_1, false);
motor leftIntake = motor(PORT1, ratio18_1, false);
motor rightIntake = motor(PORT10, ratio18_1, true);
controller Controller1 = controller(primary);
motor chuteMotor2 = motor(PORT8, ratio18_1, false);
